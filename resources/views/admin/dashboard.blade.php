                    ...
                    <div class="card-body pt-0">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h5 class="font-size-15 text-truncate">Logo Webstite</h5>
                                <p class="text-muted mb-0 text-truncate">{{ $logo->title }}</p>
                                <div class="pt-2">
                                    <div class="mt-4">
                                        <button type="button" class="btn btn-primary waves-effect waves-light btn-sm w-100" data-bs-toggle="modal" data-bs-target="#edit-logo{{ $logo->id }}">
                                            Ubah Logo <i class="mdi mdi-arrow-right ms-1"></i>
                                        </button>
                                        <div class="modal fade" id="edit-logo{{ $logo->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
                                            aria-hidden="true">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="/logo/{{ $logo->id }}" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <div>
                                                                    <img src="{{ asset('img-logo/'.$logo->image) }}" width="20%" alt="">
                                                                </div><br>  
