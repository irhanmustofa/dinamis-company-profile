        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Portofolio</h4>
                                ...
                                <table id="datatable" class="table table-bordered no-wrap w-100 dt-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    <img src="{{ asset('/storage/portofolio/'.$porto->image) }}" width="30%" alt="">
                                                </div>
                                            </td>
                                            <td>
                                                ...
                                                <div class="modal fade" id="edit-porto{{ $porto->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-body">
                                                                <form action="/portofolio/{{ $porto->id }}" method="post" enctype="multipart/form-data">
                                                                    @csrf
                                                                    @method('put')
                                                                    <div class="mb-3">
                                                                        <label for="exampleInputEmail1" class="form-label">Title</label>
                                                                        <input type="text" name="title" class="form-control" value="{{ $porto->title }}">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label for="exampleInputPassword1" class="form-label">Keterangan</label>
                                                                        <input type="text" name="description" class="form-control" value="{{ $porto->description }}">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label for="exampleInputPassword1" class="form-label">Gambar</label>
                                                                        <div>
                                                                            <img src="{{ asset('/storage/portofolio/'.$porto->image) }}" width="20%" alt="">
                                                                        </div><br>  
                                                                        <input type="file" name="image" class="form-control">
                                                                    </div>
                                                                    <button type="submit" class="btn btn-primary">Submit</button>
                                                ...
                                                <form action="portofolio/{{ $porto->id }}" method="post" class="d-inline">
                                                    @method('delete')
                                                    @csrf
